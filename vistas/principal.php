...
<section class="container">
    ...
    <ul class="nav nav-pills nav-stacked">
        ...
        <li><a href="#2" data-toggle="tab"><span class="glyphicon glyphicon-qrcode"></span> Clave de Acceso</a></li>
        <li><a href="#3" data-toggle="tab"><span class="glyphicon glyphicon-th-list"></span> Reportes</a></li>
